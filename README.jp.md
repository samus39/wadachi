...
|:------------------------------|:------------------------------------------------|:---------------------------------|:----------------------------------------|:-------------------------------|-|:-----------------------|:-----------------------------------------------|:-----------------------|:--------------------|:-----------------------------|
| <kbd>Q</kbd> [記号] / {記号2} | <kbd>W</kbd> ゠ (ダブルハイフン) / · (欧文中黒) | <kbd>E</kbd> 々 (同の字点)       | <kbd>R</kbd> 〱 (くの字点)              | <kbd>T</kbd> 〲 (くの字点)     | | <kbd>Y</kbd> ゟ (より) | <kbd>U</kbd> © (著作権記号) / ® (登録商標記号) | <kbd>I</kbd> ヿ (コト) | <kbd>O</kbd> ° (度) | <kbd>P</kbd> ′ (分) / ″ (秒) |
...
| <kbd>Z</kbd> 〻 (二の字点)    | <kbd>X</kbd> ヽ (一の字点・カナ)                | <kbd>C</kbd> ヾ (一の字点・カナ) | <kbd>V</kbd> 〵 (くの字点・下) / ゔ (※) | <kbd>B</kbd>                   | | <kbd>N</kbd>           | <kbd>M</kbd>                                   |                        |                     |                              |

※ libskk では「ゔ」をカタカナ変換しても「ヴ」に変換できず、「ヴ」のひらがなとして正しく設定できないための処置。

| 1                  | 2                  | 3                  | 4                  | 5                  | 6                  | 7                  | 8                                    | 9                                        | 0                                        |
|:-------------------|:-------------------|:-------------------|:-------------------|:-------------------|:-------------------|:-------------------|:-------------------------------------|:-----------------------------------------|:-----------------------------------------|
| <kbd>1</kbd> ○ / ● | <kbd>2</kbd> ▽ / ▼ | <kbd>3</kbd> △ / ▲ | <kbd>4</kbd> □ / ■ | <kbd>5</kbd> ◇ / ◆ | <kbd>6</kbd> ☆ / ★ | <kbd>7</kbd> ◎ / ◉ | <kbd>8</kbd> ※ (米印) / × (乗算記号) | <kbd>9</kbd> （ (全角) / 【 (隅付き括弧) | <kbd>0</kbd> ） (全角) / 】 (隅付き括弧) |

| ハイフンマイナス                             | イコール                                 | バックスラッシュ                              | グレーブアクセント              | 開きブラケット                | 閉じブラケット                |
|:---------------------------------------------|:-----------------------------------------|:----------------------------------------------|:--------------------------------|:------------------------------|:------------------------------|
| <kbd>-</kbd> – (二分ダッシュ) / − (マイナス) | <kbd>=</kbd> ≒ (近似記号) / ≠ (否定等号) | <kbd>\\</kbd> ¥ (円記号) / ± (プラスマイナス) | <kbd>`</kbd> ‘ / “ (開き引用符) | <kbd>[</kbd> 〈 / 《 (山括弧) | <kbd>]</kbd> 〉 / 》 (山括弧) |

| セミコロン                          | アポストロフィ                  | カンマ                                 | ピリオド                                 | スラッシュ                            | スペース                                           |
|:------------------------------------|:--------------------------------|:---------------------------------------|:-----------------------------------------|:--------------------------------------|:---------------------------------------------------|
| <kbd>;</kbd> ： (全角) / ∶ (比記号) | <kbd>'</kbd> ’ / ” (閉じ引用符) | <kbd>,</kbd> — (ダッシュ) / ≦ (不等号) | <kbd>.</kbd> … (三点リーダ) / ≧ (不等号) | <kbd>/</kbd> ／ (全角) / ÷ (除算記号) | <kbd>Space</kbd> 　 (全角スペース) / ␣ (空白記号) |
